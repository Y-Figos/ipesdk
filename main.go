...
import (
	...
	_ "strings"
	_ "time"
	_"codehub-g.huawei.com/ProjectIPE/IPEGOCORE/cmd"
...
func main()  {
	...
	file_handler.CreateManifest("D:\\Huawei Projects\\1- Project IPE\\IPEGOCORE\\ProjectTest", "0.2")
	manifest, err := file_handler.ParseManifest("D:\\Huawei Projects\\1- Project IPE\\IPEGOCORE\\ProjectTest\\manifest.json")
	if err != nil {
		log.Println(err)
	}
