...
func main()  {
	...
	teste := adapters.CSVReader{
		FilePath:    "D:\\Huawei Projects\\InvToolProject\\Files\\BLZ\\Inventory_Board_20250505_102510.csv", // Replace with your actual path
		BatchSize:   10000,
		WorkerCount: 8,
	}
	...
	log.Println(newdf.Columns["Board Name"].Type())
	// Memory after
